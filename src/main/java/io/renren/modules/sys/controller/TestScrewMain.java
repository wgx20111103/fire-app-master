...
public class TestScrewMain {
    ...
    private static final String DB_NAME = "renren_znnc?useUnicode=true&characterEncoding=UTF-8&serverTimezone=Asia/Shanghai";
    ...
    private static final String DOC_FILE_NAME = "智能农场系统数据库表设计文档";
    private static final String DOC_VERSION = "V1.0.0";
    private static final String DOC_DESCRIPTION = "智能农场系统数据库表设计描述";
    ...
    private static ProcessConfig buildProcessConfig() {
        return ProcessConfig.builder()
                ...
                // 忽略表名
                .ignoreTableName(Arrays.asList("test", "mytable","role","t_role"))
                // 忽略表前缀
